...
pub fn gdb_memcpy_to_qemu(conn: &mut GdbConn, dest: u32, src: &[u8]) {
...
pub fn gdb_getregs(conn: &mut GdbConn, r: &mut [u32; 43]) {
...
pub fn gdb_setregs(conn: &mut GdbConn, r: &[u32; 43]) {
